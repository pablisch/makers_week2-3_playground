...
while true do
  if river_array[level][left_right] == "C"
    puts "You were eaten."
    break
  end
  
  river_array[level][left_right] = "P"
  river_array.each { |line| puts line }
  river_array[level][left_right] = "-"
  level += 1  
  ...
  left_right += move == "left" ? -1 : move == "right" ? 1 : 0
end
